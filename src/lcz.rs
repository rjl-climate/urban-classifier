...
impl Lcz {
    ...
    pub fn simple_category(&self) -> LczCategory {
        match self {
            // Urban types (1-6)
            Lcz::CompactHighRise | Lcz::CompactMidRise | Lcz::CompactLowRise |
            Lcz::OpenHighRise | Lcz::OpenMidRise | Lcz::OpenLowRise => LczCategory::Urban,
            
            // Suburban types (7-10)
            Lcz::LightweightLowRise | Lcz::LargeLowRise | Lcz::SparselyBuilt | 
            Lcz::HeavyIndustry => LczCategory::Suburban,
            
            // Rural/Natural types (11-17)
            Lcz::DenseTrees | Lcz::ScatteredTrees | Lcz::BushScrub | Lcz::LowPlants |
            Lcz::BareRockPaved | Lcz::BareSoilSand | Lcz::Water => LczCategory::Rural,
...
mod tests {
    ...
    fn test_lcz_code_conversion() {
        ...
        for code in 1..=17 {
            ...
            assert_eq!(lcz.to_code(), code, "Code conversion failed for LCZ {}", code);
        }
    }
    ...
    fn test_lcz_categories() {
        ...
        // Test suburban types
        assert_eq!(Lcz::LightweightLowRise.simple_category(), LczCategory::Suburban);
