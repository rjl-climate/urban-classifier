...
def predict_heathrow_classification():
    ...
    print(f"📍 Location: Heathrow Airport (LHR), London, UK")
    print(f"🌐 Coordinates: {heathrow_lat}°N, {abs(heathrow_lon)}°W")
    print(f"✈️  IATA Code: LHR")
    print(f"🏗️  Infrastructure: 2 runways, 5 terminals, massive cargo facilities")
    print()
    ...
    airport_classifications = [
        (8, "Large low-rise", "Suburban", 60, "Large terminals with extensive open areas"),
        (9, "Sparsely built", "Suburban", 25, "Low building density with extensive paved areas"),
        (15, "Bare rock or paved", "Rural", 10, "If sampling mainly runway/taxiway areas"),
    ...
    simulated_result = pl.DataFrame({
        ...
        "longitude": [-0.4543],
        "latitude": [51.4700],
        "description": ["Heathrow Airport - London's primary international airport"],
...
def main():
    ...
    result = predict_heathrow_classification()
