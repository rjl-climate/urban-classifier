...
def classify_single_point(lon, lat, station_id="DEMO_STATION"):
    ...
    """
    print(f"Urban Classifier - Single Point Demo")
    print(f"===================================")
    ...
    if wudapt_file:
        ...
        try:
            ...
            if simple_class == "Urban":
                print(f"  This location is in an URBAN environment.")
                print(f"  Expect higher temperatures due to urban heat island effects.")
            elif simple_class == "Suburban": 
                print(f"  This location is in a SUBURBAN environment.")
                print(f"  Moderate urban influence on local climate.")
            else:
                print(f"  This location is in a RURAL/NATURAL environment.")
                print(f"  Minimal urban heat island influence expected.")
